    ...
    <div class="xs-pd-20-10 pd-ltr-20">
        ...
        <div class="pd-20 card-box mb-30">
            <div class="clearfix mb-20">
                <div class="pull-left">
                    <h2 class="text-blue h2">Tambah Data Kelurahan</h2>
                </div>
            </div>
            <div class="pb-20 ">
            <table id="example" class="data-table table stripe hover nowrap display-dataTables">
                    ...
                    <tbody>
                        <?php foreach ($kelurahan as $kel) : ?>
                            <tr>
                            <td>
                                <a href="<?= base_url(); ?>admin/registrasi/delete_kelurahan/<?= $kel->kd_kel; ?>"><span
        ...
        <div class="pd-20 card-box mb-30">
            <div class="clearfix mb-20">
                <form method="POST" action="<?= base_url(); ?>admin/registrasi/insert_kelurahan">
                    <div class="row">
                        <div class="col-md-12">
