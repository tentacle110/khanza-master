    ...
    <div class="xs-pd-20-10 pd-ltr-20">
        ...
        <div class="pd-20 card-box mb-30">
            <div class="clearfix mb-20">
                <div class="pull-left">
                    <h2 class="text-blue h2">Tambah Data Provinsi</h2>
                </div>
            </div>
            ...
            <table id="example" class="data-table table stripe hover nowrap display-dataTables">
                    ...
                    <tbody>
                        <?php foreach ($provinsi as $prop) : ?>
                            <tr>
                            <td>
                                <a href="<?= base_url(); ?>admin/registrasi/delete_propinsi/<?= $prop->kd_prop; ?>"><span
            ...
            <div class="pd-20 card-box mb-30">
                <div class="clearfix mb-20">
                <form method="POST" action="<?= base_url(); ?>admin/registrasi/insert_provinsi">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-check">
                                    <label for="">Provinsi</label>
                                    <input type="text" class="form-control" id="nm_prop" name="nm_prop" required>
                                </div>
                            </div>
                            <div class="row mt-4">
